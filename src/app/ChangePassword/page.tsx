...
const ChangePassword = () => {
    ...
    const handleSubmit = async (e: any) => {
        ...
        try {
            ...
            const response = await axios.put(`/changePassword/${cookies.user_id}`, {
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl md:max-w-3xl">
                        <div className="w-full p-4 md:p-8">
                            <div className="text-left font-bold">
                                <Link href={'/Dashboard'}>
                                    <span className="text-transparent bg-clip-text bg-gradient-to-tr from-[#e90b78] to-[#f06e52]"><FaArrowLeft /> Dashboard</span>
                                </Link>
                            </div>
